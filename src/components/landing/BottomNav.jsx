  ...
  return (
    <AnimatePresence>
      ...
      <motion.nav
        ...
        transition={{ type: 'spring', stiffness: 300, damping: 30 }} className="bg-[hsl(var(--foreground))] px-4 py-2 fixed top-0 left-0 right-0 z-50 backdrop-blur-xl border-b border-border flex items-center justify-between">
